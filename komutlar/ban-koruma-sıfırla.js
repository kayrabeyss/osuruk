  ...
  if (kontrol == "agayokaga") {
    ...
    if (!kanal) {
      const embed = new Discord.MessageEmbed()
        ...
        .setDescription(
          ` <a:839882697463693322:1117064465737863199> Ban koruma sistemi zaten ayarlanmamış!`
        );
    ...
    const embed = new Discord.MessageEmbed()
      ...
      .setFooter(client.user.username, client.user.avatarURL())
      .setDescription(
        ` <a:9582dsicordveriyblack:1110581570689044581> Ban koruma sistemi sıfırlandı!`
      );
    message.channel.send(embed);
    return;
  } else {
